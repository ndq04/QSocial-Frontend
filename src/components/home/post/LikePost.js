function LikePost({isLike, handleLike, handleUnLike}) {
  return isLike ? (
    ...
    <div
      className='flex items-center justify-center cursor-pointer text-gray-500 hover:bg-gray-100 py-1.5 px-10 
      rounded-md transition-colors duration-200 flex-1 dark:hover:bg-[#414345]'
      onClick={handleLike}
    >
      <svg
        xmlns='http://www.w3.org/2000/svg'
