function SavePost({saved, handleSaved, handleUnSaved}) {
  return saved ? (
    <div
      className='save-post flex items-center justify-center cursor-pointer text-purple-600 dark:text-purple-400 py-1.5
    ...
    >
      ...
      <span className='font-semibold ml-2 dark:text-gray-300'>Lưu</span>
    </div>
  )
}
